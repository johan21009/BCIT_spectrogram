...
def procesar_archivo(idx):
    ...
    for event_idx in range(num_events):
        ...
        #event.crop(tmin=1)
        componets = components[event_idx]
        ...
        for ch in ch_names:
            ...
            path = "/data/castrogaray-j/test_EDRS/subject_{}_class_{}_label_{}_event_{}_channel_{}.png".format(int(pkl[8:10]), int(pkl[-5]), label, event_idx, ch)
